...
function sendBrevoEmail(toEmail, toName, subject, htmlContent, attachments) {
...
app.post("/approve/:id", async (req, res) => {
  try {
    ...
    const submittedAt = new Date(ticket.createdAt).toLocaleString("en-KE", {
    ...
    const htmlContent = `
      ...
      <head>
        <style>
          ...
          .qr-section img { width: 220px; height: 220px; border: 4px solid #0047AB; border-radius: 8px; }
      ...
      <body>
        <div class="wrapper">
          ...
          <div class="ticket-body">
            ...
            <div class="detail-row"><span class="detail-label">Purchased At</span><span class="detail-value">${submittedAt}</span></div>
